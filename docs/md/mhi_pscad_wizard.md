...
- **defn = wizard.create_definition(project)** -> `Definition`
...
- **- :meth:`wizard.port.electrical(X, Y, "port_name", ...) <.Ports.electrical>`,**
        ...
        name
- **Definition name (hint)** `@_attribute`
        ...
        Categories = <class 'mhi.pscad.wizard.UserDefnWizard.Categories'>
- **Categories()**
        ...
        Category = <class 'mhi.pscad.wizard.UserDefnWizard.Category'>
- **Category()**
...
- **- :meth:`category.complex("param_name", ...) <.Category.complex>`,**
        ...
        Graphics = <class 'mhi.pscad.wizard.UserDefnWizard.Graphics'>
- **Graphics()**
...
- **The current defined graphic shapes (excluding port lines & arrows)**
        ...
        Line = <class 'mhi.pscad.wizard.UserDefnWizard.Line'>
- **Line()**

            A straight line


        Parameter = <class 'mhi.pscad.wizard.UserDefnWizard.Parameter'>
- **Parameter()**

            Component parameter


        Parameters = <class 'mhi.pscad.wizard.UserDefnWizard.Parameters'>
- **Parameters()**
...
- **Use :meth:`wizard.category.add(...) <.Categories.add>` to create the**
        ...
        Port = <class 'mhi.pscad.wizard.UserDefnWizard.Port'>
- **Port()**

            Component Input/Output/Electrical connections


        Ports = <class 'mhi.pscad.wizard.UserDefnWizard.Ports'>
- **Ports()**
        ...
        Rectangle = <class 'mhi.pscad.wizard.UserDefnWizard.Rectangle'>
- **Rectangle()**

            An axis-aligned rectangle.


        Scripts = <class 'mhi.pscad.wizard.UserDefnWizard.Scripts'>
- **Scripts()**

            Script Section container


        Text = <class 'mhi.pscad.wizard.UserDefnWizard.Text'>
- **Text()**

            A text label

## FUNCTIONS
    get_enum_value(kind, value)
