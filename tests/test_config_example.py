...
def test_learning_controls_and_inventory_are_documented_in_both_languages():
    ...
    inventory_fields = {
        "README.md": (
            "105 = 60 generic tools",
            "2 topology tools",
            "10 HVDC tools",
            "3 learning tools",
        ),
        "docs/zh-CN/README.md": (
            "105 = 60 个通用工具 + 2 个拓扑工具 + 10 个 HVDC 工具 + 3 个学习工具 + 8 个 LCC 工具（含 blank 生命周期） + 6 个参数化 LCC 工具 + 11 个 MMC 工具（含 blank 生命周期） + 4 个通用 Blueprint Builder 工具",
        ),
    }
    headings = {
